...
{
    Nc::Graphic::Engine *graphic = new Nc::Graphic::Engine(manager, (Nc::Graphic::Engine::CreateWindowFunc)&LightDemo::GameEngine::CreateWindow);
//    graphic->LimitFrameRate(60);
    manager->AddEngine("Graphic", graphic);
    LOG << "Creation of " << *graphic << "\t\t\t\tDONE" << endl;

    LightDemo::GameEngine *game = new LightDemo::GameEngine(graphic, manager);
