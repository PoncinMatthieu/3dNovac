...
Widget  *MainMenu::CreateDescriptionPannel(Layout *parent)
{
    ...
    //Utils::Unicode::UTF32 text(L"plop bSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemo bSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemobSplinesDemo");
