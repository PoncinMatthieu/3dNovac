...
namespace Nc
{
    namespace System
    {
        ...
        /**
            <div class="title">Inherit to the class IThread to create a thread like this : </div>
 \code
 ...
 \endcode
        ...
        */
        class LIB_NC_CORE IThread : public Utils::NonCopyable
        {
            ...
            protected:
                /** After that the Start method is called, the method Run will be called in the thread. */
                virtual void    Run() = 0;
