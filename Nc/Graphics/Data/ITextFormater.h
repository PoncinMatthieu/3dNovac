...
#ifndef NC_GRAPHICS_DATA_ITEXTFORMATER_H_
#define NC_GRAPHICS_DATA_ITEXTFORMATER_H_
...
namespace Nc
{
    namespace Graphic
    {
        ...
        */
        class LIB_NC_GRAPHICS ITextFormater
        {
            public:
                ...
                virtual void    InitDrawables(GL::DrawableArray &drawableArray) = 0;

                /**
                    Create every Drawables for the given \p text and add them to the given \p drawableArray.
                    \return the size of the text.
                */
                virtual void    ComputeDrawables(Vector2f &textSize, GL::DrawableArray &drawableArray, const Utils::Unicode::UTF32 &text) = 0;
