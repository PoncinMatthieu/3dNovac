...
namespace Nc
{
    namespace Graphic
    {
        ...
        namespace BasicMeshCreator
        {
            ...
            */
            LGRAPHICS Object *Repere(float scale, const Vector3f &center = Vector3f(0,0,0));

            /**
                Create a repere with this color sheme : Red:X  Blue:Y Green:Z
                \return the corresponding Mesh
            */
            LGRAPHICS Object *Repere(const Vector3f &scale, const Vector3f &center = Vector3f(0,0,0));
        }
    }
}
