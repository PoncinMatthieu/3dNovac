...
#ifndef NC_GRAPHICS_SCENE_UPDATINGCONTROLLER_H_
#define NC_GRAPHICS_SCENE_UPDATINGCONTROLLER_H_
    ...
    namespace Graphic
    {
        ...
        class UpdatingController : public Controller<ControllerType>, public IUpdatingController
        {
            public:
                ...
                UpdatingController(const ToVisitList &toVisitList, const VisitableList &visitableList)
                    : Controller<ControllerType>(toVisitList, visitableList)
                {}

                template<typename ToVisitList>
                UpdatingController(const ToVisitList &toVisitList)
